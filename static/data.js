...
personalProjects = {
  'Persona Notepad': {
    description:
      'A notepad inspired by my favorite game and coding language, with music and dark mode for added fun',
    tools: ['Python', 'Tkinter', 'Pillow', 'PyAudio'],
    image: '/static/images/projects/persona-notepad.png',
    url: 'https://github.com/samincgs/persona-notepad',
  },
  '2D Adventure Game': {
    description:
      'An old-school adventure RPG combining exploration, battles, and story-driven quests.',
    tools: ['Python', 'Pygame', 'JSON'],
    image: '/static/images/projects/2dadventuregame.png',
    url: 'https://github.com/samincgs/2DAdventure',
  },

  'Chess Engine': {
    description:
      'A Chess Engine built for fun, exploring game logic, strategy, and AI.',
    tools: ['Python', 'Pygame', 'NumPy', 'TensorFlow'],
    image: '/static/images/projects/chess.png',
